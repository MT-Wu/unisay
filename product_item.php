...
<div class="product_item_filter">
    ...
    <div class="one_wood_product">
        ...
        <div class="one_product_img production_link" data-sid="<?= $row['pic_id'] ?>"
             style="background-image:url(images/single_product/wood/<?= $row['pic_id'] ?>.png);">
        </div>
        ...
        <div class="one_product_info">
            ...
            <div class="add_to_cart production_link" data-sid="<?= $row['pic_id'] ?>"></div>
...
<script>
    $('.one_product_img.production_link').click(function () {
        location.href = 'single_product.php?sid=6&type=' + $(this).attr('data-sid').slice(3);
    })
