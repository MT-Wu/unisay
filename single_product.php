		...
		<div class="product_content">
			...
			<div class="product_img">
				...
				<div class="product_img_small">
					<ul>
						<li class="<?= $type === '01_cherry.png' ? 'this_pic' : '' ?>"><img src="<?= $row['pic_id'] ?>01_cherry.png"></li>
						<li class="<?= $type === '02_oak.png' ? 'this_pic' : '' ?>"><img src="<?= $row['pic_id'] ?>02_oak.png"></li>
						<li class="<?= $type === '03_maple.png' ? 'this_pic' : '' ?>"><img src="<?= $row['pic_id'] ?>03_maple.png"></li>
						<li class="<?= $type === '04_rose.png' ? 'this_pic' : '' ?>"><img src="<?= $row['pic_id'] ?>04_rose.png"></li>
						<li class="<?= $type === '05_walnut.png' ? 'this_pic' : '' ?>"><img src="<?= $row['pic_id'] ?>05_walnut.png"></li>
					</ul>
				</div>
			...
			<div class="product_info">
				...
				<div class="product_option">
					...
					<div class="add_to">
						<div class="add_to_cart">加入購物車</div>
